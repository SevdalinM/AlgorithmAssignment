...
{
    internal class AlgorithmD
    {
        public void executeAlgorithm (int[] array)
        {
            int[] array1 = new int[array.Length];
            int[] array2 = new int[array.Length];
            //the 2 arrays are taking the first 2 values of input array accordingly
            array1[0] = array[0];
            array2[0] = array[1];
            ...
            //each time the loop runs, checks which array has smaller sum and adds the new value to it.
